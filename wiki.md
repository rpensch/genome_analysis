...
The analyses that were carried out in the course of the projects are described below together with a short overview and discussion of the results. Questions from the Student Manual are answered either directly in the flow text or as a seperate point below the corresponding analyses. Results such as graphics that are referred to in the text are in the [results folder](https://github.com/rpensch/genome_analysis/tree/master/results). 
