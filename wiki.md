...
In general, the different samples and different conditions do cluster together as shown in the heat map. The PCA performed on the rlog-transformed data indicates that 99 % of the variance can be explained by the different growth mediums.
